    ...
    public class GemBoxController : Controller
    {
        ...
        public IActionResult Spreadsheet()
        {
            ExcelFile workbook = ExcelFile.Load("wwwroot/data/xlsx/SimpleTemplate.xlsx");
                ...
                {
                    //https://localhost:44326/Gembox/Spreadsheet
                    // Display sheet's name.
                    Console.WriteLine("{1} ck {0} {1}\n", worksheet.Name, new string('#', 30));
        ...
        public IActionResult GetDownload()
        {
            ...
            return File(stream, "application/force-download", "Writing.xlsx");
        }

        public IActionResult GetWordDownload()
        {
